...
namespace DDACTP034150.Controllers
{
    public class CargoBookingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BookingId,AgentEmail,CargoId,DepartDate,shiptranId")] CargoBooking cargoBooking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookingId,AgentEmail,CargoId,DepartDate,shiptranId")] CargoBooking cargoBooking)
        {
            if (ModelState.IsValid)
            {
